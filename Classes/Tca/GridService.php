...
namespace Fab\NaturalCarousel\Tca;
...
use Fab\NaturalCarousel\Grid\ColumnRendererInterface;
use Fab\NaturalCarousel\Module\ConfigurablePart;
use Fab\NaturalCarousel\Module\ModulePreferences;
use TYPO3\CMS\Core\Localization\LanguageService;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use Fab\NaturalCarousel\Exception\InvalidKeyInArrayException;
use Fab\NaturalCarousel\Facet\StandardFacet;
use Fab\NaturalCarousel\Facet\FacetInterface;
            ...
            if (!empty($additionalFields)) {
                ...
                foreach ($additionalFields as $additionalField) {
                    ...
                    if ($fieldType === FieldType::DATE) {
                        $fields[$additionalField]['format'] = 'Fab\NaturalCarousel\Formatter\Date';
                    } elseif ($fieldType === FieldType::DATETIME) {
                        $fields[$additionalField]['format'] = 'Fab\NaturalCarousel\Formatter\Datetime';
                    }
                }
