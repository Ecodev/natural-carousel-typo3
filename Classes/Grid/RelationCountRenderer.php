...
namespace Fab\NaturalCarousel\Grid;
...
class RelationCountRenderer extends ColumnRendererAbstract
{
    ...
    protected function renderForBackend()
    {
        ...
        if ($numberOfObjects > 1) {
            $label = 'LLL:EXT:natural-carousel-typo3/Resources/Private/Language/locallang.xlf:items';
            if (isset($this->gridRendererConfiguration['labelPlural'])) {
                $label = $this->gridRendererConfiguration['labelPlural'];
            }
        } else {
            $label = 'LLL:EXT:natural-carousel-typo3/Resources/Private/Language/locallang.xlf:item';
