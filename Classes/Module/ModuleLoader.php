 ...
 */
use Fab\NaturalCarousel\View\Button\ToolButton;
use Fab\NaturalCarousel\View\Button\NewButton;
use Fab\NaturalCarousel\ViewHelpers\Link\BackViewHelper;
use Fab\NaturalCarousel\View\Check\RelationsCheck;
use Fab\NaturalCarousel\View\Button\EditButton;
use Fab\NaturalCarousel\View\Button\DeleteButton;
use Fab\NaturalCarousel\View\MenuItem\ExportXlsMenuItem;
use Fab\NaturalCarousel\View\MenuItem\ExportXmlMenuItem;
use Fab\NaturalCarousel\View\MenuItem\ExportCsvMenuItem;
use Fab\NaturalCarousel\View\MenuItem\DividerMenuItem;
use Fab\NaturalCarousel\View\MenuItem\MassDeleteMenuItem;
use Fab\NaturalCarousel\Controller\ContentController;
use Fab\NaturalCarousel\Controller\ToolController;
use Fab\NaturalCarousel\Controller\FacetController;
use Fab\NaturalCarousel\Controller\SelectionController;
use Fab\NaturalCarousel\Controller\UserPreferencesController;
use Fab\NaturalCarousel\Controller\ClipboardController;
use Fab\NaturalCarousel\Utility\BackendUtility;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use TYPO3\CMS\Extbase\Utility\ExtensionUtility;
use Fab\NaturalCarousel\Exception\InvalidKeyInArrayException;

/**
 * Service class used in other extensions to register a NaturalCarousel based backend module.
 */
class ModuleLoader
{
    /**
        ...
        $this->components = [
            ...
            ModulePosition::GRID => [
                ModulePosition::TOP => [
                    ...
                    #\Fab\NaturalCarousel\View\Tab\DataTypeTab::class,
                ],
            ...
            ModulePosition::MENU_MASS_ACTION => [
                ...
                #\Fab\NaturalCarousel\View\MenuItem\MassEditMenuItem::class,
            ],
        ];
    }
    ...
    {
        // Internal NaturalCarouselCommand module registration.
        $configuration = [];
        ...
        if ($this->isShown) {
            $moduleConfiguration = [];
            #$moduleConfiguration['routeTarget'] = \Fab\NaturalCarouselCommand\Controller\ContentController::class . '::mainAction', // what to do here?
    ...
    {
        $naturalCarouselModuleCode = $this->getSignature();

        // Module code must exist
        if (empty($GLOBALS['TBE_MODULES_EXT']['vidi'][$naturalCarouselModuleCode])) {
            $message = sprintf('Invalid or not existing module code "%s"', $naturalCarouselModuleCode);
            throw new InvalidKeyInArrayException($message, 1375092053);
        }

        $result = $GLOBALS['TBE_MODULES_EXT']['vidi'][$naturalCarouselModuleCode];
