...
namespace Fab\NaturalCarousel\View\Grid;
...
use Fab\NaturalCarousel\Formatter\FormatterInterface;
use Fab\NaturalCarousel\Resolver\ContentObjectResolver;
use Fab\NaturalCarousel\Resolver\FieldPathResolver;
use Fab\NaturalCarousel\Tca\FieldType;
use TYPO3\CMS\Core\Imaging\Icon;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use Fab\NaturalCarousel\Domain\Model\Content;
use Fab\NaturalCarousel\Language\LanguageService;
use Fab\NaturalCarousel\Language\LocalizationStatus;
...
class Row extends AbstractComponentView
{
            ...
            if (in_array($fieldNameAndPath, $this->columns)) {
                ...
                if (Tca::grid()->hasRenderers($fieldNameAndPath)) {
                    ...
                    foreach ($renderers as $rendererClassName => $rendererConfiguration) {
                        /** @var $rendererObject \Fab\NaturalCarousel\Grid\ColumnRendererInterface */
                ...
                if ($this->isLanguageAllowedForBackendUser($language)) {
                    ...
                    if ($this->getLanguageService()->hasLocalization($resolvedObject, $language['uid'])) {
                        ...
                        $localizedValue = sprintf(
                            ...
                            $this->getLabelService()->sL('LLL:EXT:natural-carousel-typo3/Resources/Private/Language/locallang.xlf:create_translation')
                        );
    ...
    protected function getEmptyValuePlaceholder(): string
    {
        ...
        #return sprintf(
        #    '<i>%s</i>',
        #    $this->getLabelService()->sL('LLL:EXT:natural-carousel-typo3/Resources/Private/Language/locallang.xlf:start_editing')
        #);
        return '';
    }
