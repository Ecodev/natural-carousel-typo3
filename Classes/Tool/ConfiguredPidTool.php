...
use Fab\NaturalCarousel\Module\ModulePidService;
...
class ConfiguredPidTool extends AbstractTool
{
    ...
    {
        $templateNameAndPath = 'EXT:natural-carousel-typo3/Resources/Private/Standalone/Tool/ConfiguredPid/Launcher.html';
