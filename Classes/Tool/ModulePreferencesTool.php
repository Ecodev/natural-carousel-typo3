...
namespace Fab\NaturalCarousel\Tool;
...
use Fab\NaturalCarousel\Grid\GridAnalyserService;
...
/**
 * Module preferences for a NaturalCarousel module.
 */
class ModulePreferencesTool extends AbstractTool
{
    ...
    {
        $templateNameAndPath = 'EXT:natural-carousel-typo3/Resources/Private/Standalone/Tool/ModulePreferences/Launcher.html';
    ...
    public function work(array $arguments = array())
    {
        ...
        $templateNameAndPath = 'EXT:natural-carousel-typo3/Resources/Private/Standalone/Tool/ModulePreferences/WorkResult.html';
        $view = $this->initializeStandaloneView($templateNameAndPath);
