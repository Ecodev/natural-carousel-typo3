...
class RelationAnalyserTool extends AbstractTool
{
    ...
    {
        $templateNameAndPath = 'EXT:natural-carousel-typo3/Resources/Private/Standalone/Tool/RelationAnalyser/Launcher.html';
    ...
    {
        $templateNameAndPath = 'EXT:natural-carousel-typo3/Resources/Private/Standalone/Tool/RelationAnalyser/WorkResult.html';
        $view = $this->initializeStandaloneView($templateNameAndPath);
