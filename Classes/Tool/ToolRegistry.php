...
/**
 * Tool registry for a NaturalCarousel module.
 */
class ToolRegistry implements SingletonInterface
{
     ...
     *
     * @return \Fab\NaturalCarousel\Tool\ToolRegistry|object
     */
    public static function getInstance()
    {
        return GeneralUtility::makeInstance(\Fab\NaturalCarousel\Tool\ToolRegistry::class);
    }
