...
use Fab\NaturalCarousel\Exception\NotExistingFieldException;
...
class ConfigurationViewHelper extends AbstractViewHelper
{
    ...
    public function render()
    {
        ...
        foreach (Tca::grid()->getFields() as $fieldNameAndPath => $configuration) {
            ...
            $output .= sprintf(
                'NaturalCarousel._columns.push({ "data": "%s", "sortable": %s, "visible": %s, "width": "%s", "class": "%s", "columnName": "%s" });' . PHP_EOL,
