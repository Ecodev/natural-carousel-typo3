...
namespace Fab\NaturalCarousel\ViewHelpers\Content;
...
use Fab\NaturalCarousel\Exception\NotExistingClassException;
use TYPO3\CMS\Extbase\Persistence\Generic\QuerySettingsInterface;
use Fab\NaturalCarousel\Persistence\ResultSetStorage;
use Fab\NaturalCarousel\Resolver\FieldPathResolver;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use TYPO3\CMS\Extbase\SignalSlot\Dispatcher;
use TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper;
use Fab\NaturalCarousel\Persistence\Matcher;
...
abstract class AbstractContentViewHelper extends AbstractViewHelper
{
    ...
    {
        $this->getSignalSlotDispatcher()->dispatch('Fab\NaturalCarousel\ViewHelper\Content\AbstractContentViewHelper', 'postProcessOrderObject', array($order, $dataType));
    }
    ...
    {
        $this->getSignalSlotDispatcher()->dispatch('Fab\NaturalCarousel\ViewHelper\Content\AbstractContentViewHelper', 'postProcessMatcherObject', array($matcher, $dataType));
    }
    ...
    {
        $this->getSignalSlotDispatcher()->dispatch('Fab\NaturalCarousel\ViewHelper\Content\AbstractContentViewHelper', 'postProcessLimit', array($limit, $dataType));
    }
    ...
    {
        $this->getSignalSlotDispatcher()->dispatch('Fab\NaturalCarousel\ViewHelper\Content\AbstractContentViewHelper', 'postProcessLimit', array($offset, $dataType));
    }
