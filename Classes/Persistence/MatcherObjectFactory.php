...
use Fab\NaturalCarousel\Module\ModuleName;
...
class MatcherObjectFactory implements SingletonInterface
{
    ...
    protected function emitPostProcessMatcherObjectSignal(Matcher $matcher): void
    {
        ...
        $this->getSignalSlotDispatcher()->dispatch('Fab\NaturalCarousel\Controller\Backend\ContentController', 'postProcessMatcherObject', array($matcher, $matcher->getDataType()));
    }
