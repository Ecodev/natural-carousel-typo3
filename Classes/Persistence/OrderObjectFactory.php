...
class OrderObjectFactory implements SingletonInterface
{
     ...
     *
     * @return \Fab\NaturalCarousel\Persistence\OrderObjectFactory|object
     */
    public static function getInstance()
    {
        return GeneralUtility::makeInstance(\Fab\NaturalCarousel\Persistence\OrderObjectFactory::class);
    }
