...
class PagerObjectFactory implements SingletonInterface
{
     ...
     *
     * @return \Fab\NaturalCarousel\Persistence\PagerObjectFactory|object
     */
    public static function getInstance()
    {
        return GeneralUtility::makeInstance(\Fab\NaturalCarousel\Persistence\PagerObjectFactory::class);
    }
    ...
    {
        /** @var $pager \Fab\NaturalCarousel\Persistence\Pager */
