...
use Fab\NaturalCarousel\Persistence\Storage\NaturalCarouselDbBackend;
...
class Query implements QueryInterface
{
    ...
    {
        /** @var NaturalCarouselDbBackend $backend */
        $backend = GeneralUtility::makeInstance(NaturalCarouselDbBackend::class, $this);
